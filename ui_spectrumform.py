...
################################################################################
## Form generated from reading UI file 'spectrumformNAshlR.ui'
##
...
class Ui_SpectrumForm(object):
    def setupUi(self, SpectrumForm):
        if not SpectrumForm.objectName():
            SpectrumForm.setObjectName(u"SpectrumForm")
        SpectrumForm.resize(1201, 707)
        self.verticalLayout_7 = QVBoxLayout(SpectrumForm)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.tabWidget = QTabWidget(SpectrumForm)
        ...
        self.retranslateUi(SpectrumForm)

        self.tabWidget.setCurrentIndex(2)


        QMetaObject.connectSlotsByName(SpectrumForm)
    # setupUi

    def retranslateUi(self, SpectrumForm):
        SpectrumForm.setWindowTitle(QCoreApplication.translate("SpectrumForm", u"Dialog", None))
        self.pbtRoot.setText(QCoreApplication.translate("SpectrumForm", u"Call ROOT", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_9), QCoreApplication.translate("SpectrumForm", u"Raw data", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("SpectrumForm", u"Tabulated data", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("SpectrumForm", u"Spectrum Plot", None))
        self.groupBox_6.setTitle(QCoreApplication.translate("SpectrumForm", u"Sample description", None))
        self.groupBox_7.setTitle(QCoreApplication.translate("SpectrumForm", u"Acquisition", None))
        self.label_15.setText(QCoreApplication.translate("SpectrumForm", u"Start of acquisition", None))
        self.label_23.setText(QCoreApplication.translate("SpectrumForm", u"Delay in days", None))
        self.label_13.setText(QCoreApplication.translate("SpectrumForm", u"Live time:", None))
        self.label_12.setText(QCoreApplication.translate("SpectrumForm", u"Real time:", None))
        self.label_17.setText(QCoreApplication.translate("SpectrumForm", u"Number of channels:", None))
        self.leDelayInDays.setText(QCoreApplication.translate("SpectrumForm", u"13", None))
        self.groupBox_8.setTitle(QCoreApplication.translate("SpectrumForm", u"Quantity", None))
        self.label_18.setText(QCoreApplication.translate("SpectrumForm", u"%", None))
        self.label_19.setText(QCoreApplication.translate("SpectrumForm", u"Uncertainty:", None))
        self.cbUnit_2.setItemText(0, QCoreApplication.translate("SpectrumForm", u"L", None))
        self.cbUnit_2.setItemText(1, QCoreApplication.translate("SpectrumForm", u"mL", None))
        self.cbUnit_2.setItemText(2, QCoreApplication.translate("SpectrumForm", u"g", None))
        self.cbUnit_2.setItemText(3, QCoreApplication.translate("SpectrumForm", u"kg", None))
        self.cbUnit_2.setItemText(4, QCoreApplication.translate("SpectrumForm", u"sample", None))

        self.label_20.setText(QCoreApplication.translate("SpectrumForm", u"Value:", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QCoreApplication.translate("SpectrumForm", u"Sample", None))
        self.groupBox_5.setTitle(QCoreApplication.translate("SpectrumForm", u"Nuclide libraries", None))
        self.label_22.setText(QCoreApplication.translate("SpectrumForm", u"Analysis library:", None))
        self.label_21.setText(QCoreApplication.translate("SpectrumForm", u"Calibration library:", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("SpectrumForm", u"Peak Fit", None))
        self.label_8.setText(QCoreApplication.translate("SpectrumForm", u"# Fwhms for each peak:", None))
        self.leNoFwhmOfPeak.setInputMask("")
        self.leNoFwhmOfPeak.setText(QCoreApplication.translate("SpectrumForm", u"4,0", None))
        self.label_7.setText(QCoreApplication.translate("SpectrumForm", u"# Fwhms for each side baseline", None))
        self.leNoFwhmOfSideBaseline.setText(QCoreApplication.translate("SpectrumForm", u"5,0", None))
        self.label.setText(QCoreApplication.translate("SpectrumForm", u"Function type of baselines:", None))
        self.cbxTypeBaseline.setItemText(0, QCoreApplication.translate("SpectrumForm", u"Exponential", None))
        self.cbxTypeBaseline.setItemText(1, QCoreApplication.translate("SpectrumForm", u"Polynomial", None))
        self.cbxTypeBaseline.setItemText(2, QCoreApplication.translate("SpectrumForm", u"Exponential + constant", None))

        self.label_9.setText(QCoreApplication.translate("SpectrumForm", u"Grade of polynomial for side baselines:", None))
        self.leBaselinePolyGrade.setText(QCoreApplication.translate("SpectrumForm", u"2", None))
        self.label_5.setText(QCoreApplication.translate("SpectrumForm", u"Interpolation method for baseline under peaks:", None))
        self.cbxInterpolationMethod.setItemText(0, QCoreApplication.translate("SpectrumForm", u"Peak-height weight", None))
        self.cbxInterpolationMethod.setItemText(1, QCoreApplication.translate("SpectrumForm", u"Cubic spline", None))

        self.label_14.setText(QCoreApplication.translate("SpectrumForm", u"Fit strategy", None))
        self.cbxFitStrategy.setItemText(0, QCoreApplication.translate("SpectrumForm", u"Peak fit after baseline subtraction", None))
        self.cbxFitStrategy.setItemText(1, QCoreApplication.translate("SpectrumForm", u"baseline and peak parameters determination in one step", None))

        self.groupBox.setTitle(QCoreApplication.translate("SpectrumForm", u"Peak identification", None))
        self.label_11.setText(QCoreApplication.translate("SpectrumForm", u"Tolerance:", None))
        self.leToler.setText(QCoreApplication.translate("SpectrumForm", u"0,3", None))
        self.label_16.setText(QCoreApplication.translate("SpectrumForm", u"keV", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QCoreApplication.translate("SpectrumForm", u"Analysis Parameters", None))
        self.label_2.setText(QCoreApplication.translate("SpectrumForm", u"Energy X channel parameters", None))
        self.cbxEnChFitType.setItemText(0, QCoreApplication.translate("SpectrumForm", u"Polyn. gr. 2", None))
        self.cbxEnChFitType.setItemText(1, QCoreApplication.translate("SpectrumForm", u"Linear", None))

        self.doEnChFitPbt.setText(QCoreApplication.translate("SpectrumForm", u"Do energy x channel fit", None))
        self.pbtClearEnergyCalibration.setText(QCoreApplication.translate("SpectrumForm", u"Clear energy calibration", None))
        self.pbtAcceptNewEnergies.setText(QCoreApplication.translate("SpectrumForm", u"Accept new energy values", None))
        self.label_3.setText(QCoreApplication.translate("SpectrumForm", u"FWHM X channel parameters", None))
        self.cbxFwhmChFitType.setItemText(0, QCoreApplication.translate("SpectrumForm", u"a0 + a1 * sqrt(En)", None))
        self.cbxFwhmChFitType.setItemText(1, QCoreApplication.translate("SpectrumForm", u"a0 + a1*En + a2*En^2", None))

        self.doFwhmChFitPbt.setText(QCoreApplication.translate("SpectrumForm", u"Do FWHM x channel fit", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("SpectrumForm", u"Peak Search", None))
        self.tlBinFiltGr.setText(QCoreApplication.translate("SpectrumForm", u"Binomial filter grade", None))
        self.leBinFiltGr.setText(QCoreApplication.translate("SpectrumForm", u"2", None))
        self.tlPkcut.setText(QCoreApplication.translate("SpectrumForm", u"Search sensitivity", None))
        self.lePkcut.setText(QCoreApplication.translate("SpectrumForm", u"0,3", None))
        self.tlSideChannelsSearch.setText(QCoreApplication.translate("SpectrumForm", u"# of channels on each side:", None))
        self.leSideChannelsSearch.setInputMask("")
        self.leSideChannelsSearch.setText(QCoreApplication.translate("SpectrumForm", u"6", None))
        self.label_10.setText(QCoreApplication.translate("SpectrumForm", u"Data points:", None))
        self.pbtNewSearch.setText(QCoreApplication.translate("SpectrumForm", u"New search", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), QCoreApplication.translate("SpectrumForm", u"Energy Calibration", None))
        self.label_6.setText(QCoreApplication.translate("SpectrumForm", u"Efficiency points - number:", None))
        self.neffptsLne.setText("")
        self.doefficfitPbt.setText(QCoreApplication.translate("SpectrumForm", u"Do fit", None))
        self.label_4.setText(QCoreApplication.translate("SpectrumForm", u"Efficiency X energy parameters - Polynomial grade:", None))
        self.polygradeLne.setText(QCoreApplication.translate("SpectrumForm", u"5", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), QCoreApplication.translate("SpectrumForm", u"Efficiency Calibration", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_10), QCoreApplication.translate("SpectrumForm", u"Nuclide Lib.", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), QCoreApplication.translate("SpectrumForm", u"Peak Report", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_11), QCoreApplication.translate("SpectrumForm", u"Activities", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), QCoreApplication.translate("SpectrumForm", u"Fit Log", None))
    # retranslateUi
